"""tcg_project_28650 URL Configuration
...
admin.site.site_header = "TCG Project"
admin.site.site_title = "TCG Project Admin Portal"
admin.site.index_title = "TCG Project Admin"

# swagger
api_info = openapi.Info(
    title="TCG Project API",
    default_version="v1",
    description="API documentation for TCG Project App",
)
